var foursScoreBoard=function(cricket,four)
{
    ...
    {
        var totalFoursResult=cricket[i];        
        if(totalFoursResult.four>0)
        {
            count++;
            totalFours.push(totalFoursResult);
        }
    }
        return totalFours;
}
...
var cricket = [
              [{over:1, ball:0.1, runs:0, four:1, six:0, wicket:0},
...
var totalFoursInCricket=foursScoreBoard(cricket,4);
console.log(totalFoursInCricket);
var totalSixesInCricket=sixesScoreBoard(cricket,6);
